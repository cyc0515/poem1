<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="标签信息" prop="label">
        <el-input
    ...
    <el-table v-loading="loading" :data="labelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="标签信息" align="center" prop="label" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="标签信息" prop="label">
          <el-input v-model="form.label" placeholder="请输入标签信息" />
        </el-form-item>
      </el-form>
...
<script>
import { listLabel, getLabel, delLabel, addLabel, updateLabel, exportLabel } from "@/api/poem/label";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除诗词名称为"' + poemNames + '"的标签项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有诗词标签数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
